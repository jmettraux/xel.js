...
var Xel = (function() {
  ...
  evals.LET = function(tree, context) {
    ...
    while (true) {
      ...
      if (k && v) {
        k = k[0] === 'var' ? k[1] : self.eval(k, ctx);
        r = ctx[k] = self.eval(v, ctx);
        continue;
      }

      if (k) r = self.eval(k, ctx);
